...
#Creating the common Logging objectxx
...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            cols_to_drop = ['TSH_measured', 'T3_measured', 'TT4_measured', 'T4U_measured', 'FTI_measured', 'TBG_measured', 'TBG']
            data = preprocessor.dropUnnecessaryColumns(data, cols_to_drop)
